...
do
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://imgur.com/a/c1aElZN")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            utility:LoadImage(colorpicker__gradient, "gradient", "https://imgur.com/a/c1aElZN")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://imgur.com/a/c1aElZN")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://imgur.com/a/c1aElZN")
        --
    ...
    function sections:Button(info)
        ...
        --
        utility:LoadImage(button_gradient, "gradient", "https://imgur.com/a/c1aElZN")
        --
        library.began[#library.began + 1] = function(Input)
    ...
    function sections:Dropdown(info)
        ...
        utility:LoadImage(dropdown__gradient, "gradient", "https://imgur.com/a/c1aElZN")
        --
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", "https://imgur.com/a/c1aElZN")
        --
    ...
    function sections:ConfigBox(info)
        ...
        --
        utility:LoadImage(configLoader_gradient, "gradient", "https://imgur.com/a/c1aElZN")
        --
